    ...
    <ScrollView>
      <StackLayout>
        ...
        <MDButton
          ...
          color="red"
          src="res://ic_action_add"
          text="button with icon and tint"
          @tap="onTap"
        />
...
export default {
  ...
  methods: {
    ...
    onTap(event: { object: any }) {
      console.log('Button tapped', event.object, Date.now());
    },
    switchExpanded(event: { object: { nativeView: any } }) {
